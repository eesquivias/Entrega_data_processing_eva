...
object JdbcProvisioner {
  ...
  def main(args: Array[String]) {
    ...
    try {
      ...
      println("Creando la tabla de métricas agregadas de bytes (timestamp TIMESTAMP, id TEXT, value BIGINT, type TEXT)")
      ...
      println("Dando de alta la información de usuarios") //provisión de metadatos
